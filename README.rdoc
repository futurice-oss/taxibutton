...
Read {our blog post}[http://futurice.com/blog/one-click-taxi-ordering] (you probably came from there)

1. Connect button to Arduino (remember to add pull-up resistor, see for example {this tutorial}(http://arduino.cc/en/tutorial/button)) and upload button.pde from arduino subdirectory.
2. Install kannel
...
Feel free to contact <olli.jarva@futurice.com> when you have any problems. I'll try to answer, but I can't make any promises.
